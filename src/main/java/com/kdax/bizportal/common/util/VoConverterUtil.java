...
public class VoConverterUtil {
    ...
    public static Map domainToMap(Object vo) throws IllegalAccessException, IntrospectionException, InvocationTargetException {
        return domainToMapWithExcept(vo, notExistArr);
    }

    public static Map<String, Object> domainToMapWithExcept(Object vo, String[] arrExceptList) throws IntrospectionException, InvocationTargetException, IllegalAccessException {
